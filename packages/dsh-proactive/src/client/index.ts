...
declare module "@deepseek-ai/dsh-client-ui-slots" {
  interface LocaleNamespaceMap {
    ...
    "dsh-proactive": "tabLabel" | "globalTitle" | "sessionTitle" | "sessionSubtitle" | "refresh" | "newAlarm" | "create" | "save" | "cancel" | "pause" | "resume" | "fire" | "edit" | "history" | "hideHistory" | "copyId" | "copied" | "alarms" | "session" | "prompt" | "promptPlaceholder" | "state" | "nextDue" | "type" | "target" | "emptyAlarms" | "emptyRuns" | "filterAllStates" | "filterAllSessions" | "filterAllTypes" | "sortBy" | "sortNextDue" | "sortCreated" | "sortPrompt" | "stateScheduled" | "stateOverdue" | "stateInFlight" | "stateCompleted" | "stateCancelled" | "stateFailed" | "statePaused" | "typeOnce" | "typeEvery" | "typeCron" | "targetResume" | "targetFork" | "targetNew" | "quietLabel" | "runTime" | "runDecision" | "runBudget" | "runSummary" | "thinkingPrefix" | "replyPrefix" | "delaySeconds" | "atDateTime" | "everySeconds" | "cronExpression" | "cronPlaceholder" | "jitterSeconds" | "jitterPlaceholder" | "jitterEveryHint" | "respectQuietHours" | "quietHint" | "targetSessionId" | "forkSourceSessionId" | "targetSessionPlaceholder" | "invalidSessionId" | "newSessionHint" | "budget" | "perDay" | "quietHours" | "quietHoursStart" | "quietHoursEnd" | "globalView" | "configSectionTitle" | "configSectionDesc" | "enabledToggle" | "defaultPromptLabel" | "defaultPromptHint" | "saveConfig" | "saved" | "loadFailure" | "loading" | "close" | "openSettings" | "error" | "confirmCancel" | "storageCorrupt" | "hostPanelLabel" | "dateTimeLocale";
  }
}
